#include<iostream>
using namespace std;
// A class to represent a node in the adjacency list.
class node{
	public:
	int data;
	node *link;
};
// A class to represent list of vertexes connected to the given vertex.
class vertexlist{
	public:
	node *vlisthead;
};
// A class to maintain the graph vertexes and its connections to other vertexes.
class Graph{
	public:
	int v;
	vertexlist *vl; 
